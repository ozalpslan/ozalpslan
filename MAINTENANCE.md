...
The name and role use solid cyan: `#00B2EF` in dark mode and the darker `#007EAD` in light mode for readability on white. The description stays neutral; yellow remains in the logo.
